<?php
	...
	if ($_POST["ds160id"] != "") {
		$sql = "UPDATE appds160 SET marriage = ?, nationality = ?, othernations = ?, nationid = ?, ssn = ?, "
			. "mailaddress = ?, othercontact = ?, socialmedia = ?, ppissues = ?, "
		...
		$stmt = $conn->prepare($sql);
		$stmt->bind_param("sssssssssssssssssssssi", $_POST["marriage"], $_POST["nationality"], $_POST["othernations"],  $_POST["nationid"], 
										$_POST["ssn"], $_POST["mailaddress"], $_POST["othercontact"], $_POST["socialmedia"], $_POST["ppissues"], 
